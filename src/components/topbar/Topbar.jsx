  ...
  return (
    <div className="topbarContainer" style={{ position: 'sticky', top: 0, zIndex: 999 }}>
      ...
      <div className="topbarLeft">
        <div className="topbarMenuIcon" onClick={toggleLeftDrawer} title="Open Menu">
      ...
      <div className="topbarRight">
        ...
        <div className="topbarIcons">
          ...
          <div className="topbarIconItem mobileSearchToggle" onClick={() => setMobileSearchOpen(!mobileSearchOpen)} title="Toggle Search">
            <i className={`fa ${mobileSearchOpen ? 'fa-times' : 'fa-search'} ic`}></i>
          </div>
          ...
          {/* Mobile Rightbar Drawer Toggle */}
          <div className="topbarIconItem mobileRightbarToggle" onClick={toggleRightDrawer} title="Online Friends">
            <i className="fa fa-users ic"></i>
          </div>
        </div>
      ...
      {/* Mobile absolute search input */}
      {mobileSearchOpen && (
        <div className="topbarMobileSearch">
          <div className="searchbar">
            <i className="fa fa-search searchIcon"></i>
            <input
              placeholder="Search for friend, post or video"
